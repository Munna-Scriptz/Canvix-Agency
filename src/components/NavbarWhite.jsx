    ...
    <>
        <nav className='bg-transparent py-[22px] lg:block hidden'>
            ...
            <div id="Nav-Row" className='flex items-center justify-between'>
                ...
                <Link to={'/'} id='HoverLinksBlack' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-delay="1000">Home</Link>
                <Link to={'/about'} id='HoverLinksBlack' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-delay="1200">About</Link>
                <Link to={'/contact'} id='HoverLinksBlack' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-delay="1400">Contact Us</Link>
                </div>
                {/* ---------------Nav Button----------- */}
