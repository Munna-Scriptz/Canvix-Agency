...
const CommonButton = () => {
  return (
    <>
    <button className="relative bg-white text-white font-medium md:text-[17px] text-sm px-5 py-[12px] pl-5 lg:h-[48px] h-[40px] rounded-full flex items-center overflow-hidden cursor-pointer group">
