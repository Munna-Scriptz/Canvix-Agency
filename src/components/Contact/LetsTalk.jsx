...
const LetsTalk = () => {
  return (
    <>
        <section id='Lets-Talk' className='mt-[85px] overflow-hidden'>
            <div className="container">
                <div id="Lets-Talk-Row" className='flex lg:flex-row flex-col items-center justify-between'>
                    {/* ---------------------------left Side------------------------------ */}
                    <div className='lg:w-[401px]'>
                        <h2 className='lg:text-[64px] text-[36px] text-primary font-roboto font-semibold' data-aos="fade-right">Let’s talk</h2>
                        <p className='text-[#0C0C0CE5] text-lg font-dmSans lg:mt-[32px] mt-[24px]' data-aos="fade-right">We collaborate with thousands of creators, entrepreneurs and complete legends.</p>
                        {/* ------Border */}
                        <div className='w-full h-[1px] bg-[#DFDFDF] my-7.5' data-aos="fade-right"></div>
                        {/* ------Border */}
                        <div className='flex items-center md:gap-[26px] gap-[16px]' data-aos="fade-right">
                        ...
                        <div className='flex items-center md:gap-[26px] gap-[16px] mt-5' data-aos="fade-right">
                            <div className='md:w-[50px] w-[40px] md:h-[50px] h-[40px] bg-primary text-white md:text-3xl text-2xl rounded-full flex items-center justify-center'>
                                <PiPhoneCallLight />
                            </div>
                            <div>
                        ...
                        <div className='flex items-center gap-3'>
                            <div className='w-[50px] h-[50px] rounded-full text-2xl cursor-pointer hover:bg-primary duration-300 flex items-center justify-center hover:text-white' data-aos="fade-right">
                                <SlSocialFacebook />
                            </div>
                            <div className='w-[50px] h-[50px] rounded-full text-2xl cursor-pointer hover:bg-primary duration-300 flex items-center justify-center hover:text-white' data-aos="fade-right">
                    ...
                    <div className='lg:w-[795px] bg-[#F4F4F4] rounded-[20px] lg:p-[45px] p-[22px] lg:mt-0 mt-10'>
                        ...
                        <div className='flex lg:flex-nowrap flex-wrap items-center justify-between'>
                            <div className='lg:w-[326px] w-full flex flex-col' data-aos="fade-left">
                            ...
                            <div className='lg:w-[326px] w-full flex flex-col lg:mt-0 mt-6' data-aos="fade-left">
                        ...
                        {/* -------------------------Third Row */}
                        <div className='flex lg:flex-nowrap flex-wrap items-center justify-between lg:mt-[52px] mt-6'>
                            <div className='w-full flex flex-col' data-aos="fade-left">
                        ...
                        {/* -----------------------Send Button  */}
                        <div className='mt-[52px]' data-aos="fade-left">
