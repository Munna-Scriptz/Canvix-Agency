...
const Recent = () => {
    return (
        <>
            <section id='Recent' className='mt-[112px] overflow-hidden'>
                <div className="container">
                    <div id="Recent-Row">
                        {/* -----------------Header----------------- */}
                        <h2 className='text-center font-roboto font-semibold lg:text-[54px] text-[36px] text-primary lg:mb-0 mb-10' data-aos="fade-up">Recent Showcase</h2>
                        {/* -----------------ShowCase Images----------------- */}
                        <div className='flex lg:flex-row flex-col items-center justify-between'>
                            ...
                            <div className='lg:mt-[172px] flex lg:flex-col flex-col-reverse lg:items-end'>
                                <button className="relative lg:mt-0 mt-10 bg-primary text-white font-medium text-[17px] px-5 py-[12px] pl-5 h-[48px] rounded-full flex items-center overflow-hidden cursor-pointer group" data-aos="fade-left">
