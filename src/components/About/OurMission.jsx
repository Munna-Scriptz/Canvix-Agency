...
const OurMission = () => {
  ...
  return (
    <>
        <section id='Our-Mission' className='bg-primary mt-[100px] md:pt-[100px] pt-[60px] pb-[133px]'>
            <div className="lg:mx-[60px] mx-[16px]">
                <div id="Our-Mission-Row" className='flex lg:flex-nowrap flex-wrap items-center justify-between'>
                    ...
                    <div className='lg:w-[600px]'>
                        <p className='text-brand font-roboto font-bold lg:text-[25px] text-lg mb-6'>Our Mission</p>
                        <h2 className='text-white font-semibold lg:text-[64px] text-[32px] font-roboto leading-[120%] md:mb-8 mb-6'>Boost your with your business.</h2>
                        <p className='text-borderCol font-dmSans lg:text-lg mb-[48px]'>He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty gay assistance joy.</p>
                    ...
                    <div className='flex lg:flex-nowrap flex-wrap items-end lg:mt-0 mt-10'>
                        <div className='relative'>
                            ...
                            <div className='flex animate-wiggle items-center mt-[20px] lg:mb-0 mb-10'>
                                ...
                                {/* ------Border----- */}
                                <div className='h-[123px] bg-white w-[1px] lg:mx-[23px] mx-[10px]'>
