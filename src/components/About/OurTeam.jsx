        ...
        <>
            <section id='Our-team' className='mt-[100px]'>
                <div className="container">
                    <div id="Our-team-Row">
                        {/* -------------------------Header---------------------------- */}
                        <h2 className='text-center text-primary lg:text-[64px] text-[36px] font-semibold font-roboto mb-[60px]' data-aos="fade-up">Our Team</h2>
                        {/* -------------------------Cards---------------------------- */}
                        <div className='flex lg:flex-nowrap flex-wrap items-center justify-between lg:gap-[74px] gap-[52px]'>
                            {
                                memberData.map((item, i) => (
                                    <div key={i} className='relative' data-aos="fade-up">
                                        ...
                                        <h2 className='text-primary font-roboto font-semibold text-xl mt-4' data-aos="fade-up">{item.name}</h2>
                                        <p className='text-[#0C0C0CE5] text-base font-dmSans mt-[10px]' data-aos="fade-up">{item.role}</p>
                                        {/* ------------Media  */}
                                        <div className='absolute top-[15px] right-[15px] flex items-center gap-[10px]' data-aos="fade-up">
